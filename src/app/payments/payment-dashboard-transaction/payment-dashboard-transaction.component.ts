...
@Component({
  ...
  imports: [CommonModule, MatMenuModule, MatInputModule,ReactiveFormsModule, MatSelectModule, MatDatepickerModule, MatNativeDateModule, MatDateRangePicker, MatTableModule, MatDividerModule, FormsModule, NgbPaginationModule, MatSelectSearchComponent],  
  animations: [
