...
const meta: Meta<PaymentDashboardTransactionComponent> = {
  title: 'Payments/Payment Dashboard/Dashboard Transactions/Transaction list',
  component: PaymentDashboardTransactionComponent,
   decorators: [
    moduleMetadata({
      declarations: [
      ],
...
type Story = StoryObj<PaymentDashboardTransactionComponent>;

export const EmptyTransactions: Story = {
  args: {
    walletTransactionAll: [],
  },
};

export const PopulatedTransactions: Story = {
  args: {
    walletTransactionAll: AccountTransactionsData,
  },
};
