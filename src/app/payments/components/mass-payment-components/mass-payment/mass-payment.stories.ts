...
class MockWalletsService {
  ...
  activeCurrentWallet = of(mockWalletList[0]);
  lengthValue$ = of(1);
  getIsCompleteMassPayment = () => of(false);

  setIsCompleteMassPayment(value: boolean) {}
  SetImportMassPAymentFile(event: any) {}
}

const meta: Meta<MassPaymentComponent> = {
  title: 'Payments/Payment Dashboard/Payments/Mass Payment',
  component: MassPaymentComponent,
  decorators: [
    moduleMetadata({
      declarations: [
      ...
      providers: [
        ...
        { provide: MAT_DIALOG_DATA, useValue: { walletList: mockWalletList } },
...
type Story = StoryObj<MassPaymentComponent>;
