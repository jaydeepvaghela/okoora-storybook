...
const meta: Meta<WalletListDialogComponent> = {
  title: 'Payments/Payment Dashboard/Payments/Mass Payment/Recipient Table/Wallet-list Popup',
  component: WalletListDialogComponent,
  decorators: [
    moduleMetadata({
      imports: [
        CommonModule,
...
export default meta;
type Story = StoryObj<WalletListDialogComponent>;
