...
@Component({
  selector: 'app-payment-calendar-header',
  templateUrl: './payment-calendar-header.component.html',
  styleUrls: ['./payment-calendar-header.component.scss'],
  imports: [CommonModule, MatSelectModule, FormsModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PaymentCalendarHeaderComponent<D> implements OnDestroy {
